...
func run() (err error) {
	...
	duplicateKeyScenario(ctx, pool)
	distinctKeysScenario(ctx, pool)
	autoGeneratedKeyScenario(ctx, pool)
	sweepScenario(ctx, pool)
	configRoundTripScenario(ctx, pool)
...
func sweepScenario(ctx context.Context, pool *pgxpool.Pool) {
