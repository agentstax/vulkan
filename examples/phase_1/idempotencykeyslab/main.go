...
func duplicateKeyScenario(ctx context.Context, ds *iDatastore.PostgresDatastore) {
	...
	calls := 0
	fn := func(ctx context.Context, tx producer.Tx, gotKey string) (*common.Work, error) {
		calls++
		if gotKey != key {
...
func autoGeneratedKeyScenario(ctx context.Context, ds *iDatastore.PostgresDatastore) {
	...
	for range 3 {
		_, err := wpInstance.ProduceFunc(ctx, func(ctx context.Context, tx producer.Tx, k string) (*common.Work, error) {
			if k == "" {
