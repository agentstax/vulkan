...
func failOne(ctx context.Context, cd *consumer.ConsumerDatastore[common.Work], wp *producer.Producer[common.Work], tp *topic.Topic, groupID int64, n int) int64 {
	seed(ctx, wp, n)
