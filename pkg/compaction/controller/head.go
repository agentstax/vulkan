...
func (c *CompactionController) GetHead[Message common.Versioned](ctx context.Context, topicId int64, messageKey string) (*common.MessageData[Message], error) {
	if topicId <= 0 {
...
// by message key.
func (c *CompactionController) ListHeads[Message common.Versioned](ctx context.Context, topicId int64) ([]*common.MessageData[Message], error) {
	if topicId <= 0 {
		return nil, fmt.Errorf("topicId must be > 0, got %d", topicId)
	}
