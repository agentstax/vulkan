...
func (c *CompactionController) ListKeyMessages[Message common.Versioned](ctx context.Context, topicId int64, messageKey string, limit int) ([]*common.MessageData[Message], error) {
	if topicId <= 0 {
