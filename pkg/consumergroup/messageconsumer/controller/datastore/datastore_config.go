...
type MessageConsumerGroupDatastoreConfig struct {
...
func (c *MessageConsumerGroupDatastoreConfig) WithDefaults() *MessageConsumerGroupDatastoreConfig {
	if c.Logger == nil {
...
func (c *MessageConsumerGroupDatastoreConfig) Validate() error {
