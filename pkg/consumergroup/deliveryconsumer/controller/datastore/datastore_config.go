...
type DeliveryConsumerGroupDatastoreConfig struct {
...
func (c *DeliveryConsumerGroupDatastoreConfig) WithDefaults() *DeliveryConsumerGroupDatastoreConfig {
	if c.Logger == nil {
...
func (c *DeliveryConsumerGroupDatastoreConfig) Validate() error {
