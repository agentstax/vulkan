...
type CronSchedulerDatastoreConfig struct {
...
func (c *CronSchedulerDatastoreConfig) WithDefaults() *CronSchedulerDatastoreConfig {
	if c.Logger == nil {
...
func (c *CronSchedulerDatastoreConfig) Validate() error {
