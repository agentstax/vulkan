...
type ScheduleProducerDatastoreConfig struct {
...
func (c *ScheduleProducerDatastoreConfig) WithDefaults() *ScheduleProducerDatastoreConfig {
	if c.Logger == nil {
...
func (c *ScheduleProducerDatastoreConfig) Validate() error {
