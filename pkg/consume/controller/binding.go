...
func (c *ConsumeController) GetBinding(ctx context.Context, topicId int64, groupId int64) (*consume.Binding, error) {
	...
	return toBinding(effective), nil
}
