...
// BindingConfigLogStatus is the binding_config_log.status column's value set.
type BindingConfigLogStatus string

const (
	BindingConfigLogInstalled BindingConfigLogStatus = "installed" // a set change that took effect
	BindingConfigLogWaiting   BindingConfigLogStatus = "waiting"   // an attempt blocked by a live instance's different set
)
