...
func NewBaseConsumer[Message common.Versioned](baseProvisioner *BaseProvisioner[Message], owner *common.Owner, resolvedTopic *topic.TopicData, cfg *BaseConsumerConfig) (*BaseConsumer[Message], error) {
