...
func newDeliveryRunner[Message any](base *consumerbase.BaseConsumer[Message], consumers *controller.DeliveryConsumerController, cfg *DeliveryConsumerConfig) (*deliveryRunner[Message], error) {
	if base == nil {
