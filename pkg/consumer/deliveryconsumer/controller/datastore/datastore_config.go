...
type DeliveryConsumerDatastoreConfig struct {
...
func (c *DeliveryConsumerDatastoreConfig) WithDefaults() *DeliveryConsumerDatastoreConfig {
	if c.Logger == nil {
...
func (c *DeliveryConsumerDatastoreConfig) Validate() error {
