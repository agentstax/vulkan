...
func newMessageRunner[Message any](base *consumerbase.BaseConsumer[Message], consumers *controller.MessageConsumerController, cfg *MessageConsumerConfig) (*messageRunner[Message], error) {
	if base == nil {
