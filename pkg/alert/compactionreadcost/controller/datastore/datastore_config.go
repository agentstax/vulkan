...
type CompactionReadCostDatastoreConfig struct {
...
func (c *CompactionReadCostDatastoreConfig) WithDefaults() *CompactionReadCostDatastoreConfig {
	if c.Logger == nil {
...
func (c *CompactionReadCostDatastoreConfig) Validate() error {
