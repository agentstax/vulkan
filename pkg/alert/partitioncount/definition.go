...
func (d *PartitionCountDefinition) Provision(ctx context.Context, workerId int64, owner *common.Owner, metadata any) (worker.Execution, error) {
	claimed, _, err := workercontroller.RegisterInstance[partitionCountMetadata](ctx, d.workers, workerId, owner, common.OwnerConsumerGroup, JobName, metadata, d.Config.InstanceTTL)
