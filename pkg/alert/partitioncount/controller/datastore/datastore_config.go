...
type PartitionCountDatastoreConfig struct {
...
func (c *PartitionCountDatastoreConfig) WithDefaults() *PartitionCountDatastoreConfig {
	if c.Logger == nil {
...
func (c *PartitionCountDatastoreConfig) Validate() error {
