...
var ErrSystemLive = diagnostic.NewDiagnosticError("VK0010", diagnostic.RecoveryPermanent,
...
var ErrTopicsRegistered = diagnostic.NewDiagnosticError("VK0011", diagnostic.RecoveryPermanent,
	"topics are still registered",
...
var ErrSchemaNotCreatable = diagnostic.NewDiagnosticError("VK0064", diagnostic.RecoveryPermanent,
