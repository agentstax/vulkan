...
-- impossible -- same reason latest_key exists as its own table rather than
...
CREATE INDEX IF NOT EXISTS idempotency_key_topic_created_at
  ON idempotency_key (topic_id, created_at);
