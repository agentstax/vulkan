...
- [x] Site stack — SETTLED 2026-08-23 (user): keep Astro, DROP Starlight
  ...
  LIVE CONSOLE SLICE BUILT (2026-08-23, user notes pending —
  "will have notes when I see code"):
  - vulkan-sql/ dir (USER: one file per SQL statement): 33 files
    ...
    order; vulkan-sql.test.ts (vitest, `npm run test`) asserts
